...
def initialize_system():
    ...
    # Use a tool-enabled Ollama model. The default llama3 does not support tools.
    # We must first pull the model using `ollama pull codestral` in the terminal.
...
if __name__ == "__main__":
    ...
    investigation_query = "What is the KYC information for Alice Johnson (CUST103), what is her transaction history, and what is her PEP status? Also check if any associated UBOs are on the PEP list."
